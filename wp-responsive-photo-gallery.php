       ...
       <div id="poststuff" >
        <div id="post-body" class="metabox-holder columns-2">
                <div style="" id="post-body-content" >
                    ...
                    <pre class="printCode">[print_my_responsive_photo_gallery]</pre>
                    <div class="clear"></div>
                    <h3>To print this slider into WordPress theme/template PHP files use bellow code</h3>
                    <pre class="printCode">echo do_shortcode('[print_my_responsive_photo_gallery]'); </pre>
                    <div class="clear"></div>
                </div>
...
<h3>To print this slider into WordPress theme/template PHP files use bellow code</h3>
<pre class="printCode">
  echo do_shortcode('[print_my_responsive_photo_gallery]'); 
</pre>
<div class="clear"></div>
<?php       
   }
